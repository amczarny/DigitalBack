...
- {id: GPT1_ipg_clk_highfreq.outFreq, value: 25 MHz}
- {id: GPT2_ipg_clk_highfreq.outFreq, value: 25 MHz}
...
- {id: CCM.PERCLK_PODF.scale, value: '5', locked: true}
...
- {id: CCM_ANALOG.PLL3_PFD0_DIV.scale, value: '22'}
- {id: CCM_ANALOG.PLL3_PFD1_DIV.scale, value: '22', locked: true}
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set PERCLK_PODF. */
    CLOCK_SetDiv(kCLOCK_PerclkDiv, 4);
    ...
    /* Init Usb1 pfd1. */
    CLOCK_InitUsb1Pfd(kCLOCK_Pfd1, 22);
    /* Init Usb1 pfd2. */
